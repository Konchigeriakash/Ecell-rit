...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-background">
      <header className="px-4 lg:px-6 h-20 flex items-center border-b bg-white">
      ...
      <main className="flex-1">
        ...
        <section id="login-roles" className="w-full py-12 md:py-24 lg:py-32 bg-white">
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="text-center mt-6">
              <Button variant="secondary" asChild>
                <Link href="#">Read Guidelines <BookOpen className="ml-2 h-4 w-4" /></Link>
              </Button>
            </div>
          </div>
        </section>
...
function RoleCard({ icon: Icon, title, description, href }: { icon: React.ElementType, title: string, description: string, href: string }) {
  return (
    <div className="flex flex-col items-center justify-center p-6 bg-background rounded-lg shadow-md text-center">
